#!/usr/bin/perl -w
#
# <SS>This is the basis of an application with signal handlers</SS>
#
...
#==============================================================================
#=== <SS>This is the</SS> 'BusFrame' class                              
#==============================================================================
package BusFrame;
require 5.000; use strict 'vars', 'refs', 'subs';
# UI class 'BusFrame' (<SS>version</SS> 0.01)
# 
...
#===============================================================================
#=== <SS>Below are the default signal handlers for</SS> 'BusFrame' class
#===============================================================================
sub about_Form {
    my ($class) = @_;
    my $gtkversion = 
...
#==============================================================================
#=== <SS>Below are the signal handlers for</SS> 'BusFrame' class 
#==============================================================================
...
#==============================================================================
#=== <SS>This is the</SS> 'fileselection1' class                              
#==============================================================================
package fileselection1;
require 5.000; use strict 'vars', 'refs', 'subs';
# UI class 'fileselection1' (<SS>version</SS> 0.01)
# 
# <SS>Copyright</SS> (c) <SS>Date</SS> Tue Feb 29 17:46:24 GMT 2000
# <SS>Author</SS> Dermot Musgrove <dermot.musgrove\@virgin.net>
#
...
#===============================================================================
#=== <SS>Below are the default signal handlers for</SS> 'fileselection1' class
#===============================================================================
sub about_Form {
    my ($class) = @_;
    my $gtkversion = 
...
#==============================================================================
#=== <SS>Below are the signal handlers for</SS> 'fileselection1' class 
#==============================================================================
...
Bus - <SS>version</SS> 0.01 Tue Feb 29 17:46:24 GMT 2000
...
=head1 SYNOPSIS
 ...
 if ($<SS>we_want_to_subclass_this_class</SS>) {
   # <SS>Inherit the AUTOLOAD dynamic methods from</SS> BusFrame
